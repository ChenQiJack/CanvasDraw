package spotlight.com.canvasdraw.Unity;
...
public class CanvasView extends View {
    ...
    private void updateHistory(Path path) {
        Log.v("update_historyPointer",historyPointer+";");
     ...
     */
    public boolean undo() {
        Log.v("undo_historyPointer",historyPointer+";");
     ...
     */
    public void clear() {
//        Log.v("clear_historyPointer", historyPointer + ";");
//        historyPointer = 0;
//        this.pathLists.clear();
//        this.paintLists.clear();
//        Path path = new Path();
//        path.moveTo(0F, 0F);
//        path.addRect(0F, 0F, 0F, 0F, Path.Direction.CCW);
//        path.close();
//        Paint paint = new Paint();
